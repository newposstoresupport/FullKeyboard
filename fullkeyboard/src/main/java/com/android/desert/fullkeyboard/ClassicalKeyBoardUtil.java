...
/**
 * @ClassName: ClassicalKeyBoardUtil
 ...
 */
public class ClassicalKeyBoardUtil {

    private Context mContext;
    private int widthPixels;
    private Activity mActivity;
    private ClassicalKeyBoardView keyboardView;
    // 字母键盘
    ...
    private ClassicalKeyBoardUtil mKeyboardUtil;
     ...
     */
    public ClassicalKeyBoardUtil(Context ctx, LinearLayout rootView, ScrollView scrollView) {
        this.mContext = ctx;
     ...
     */
    public ClassicalKeyBoardUtil(View view, Context ctx, LinearLayout root_View, ScrollView scrollView) {
    ...
    private void initKeyBoardView(LinearLayout rootView) {
        ...
        keyBoardLayout = inflater.inflate(R.layout.classical_input, null);
        ...
        if (keyBoardLayout != null && keyBoardLayout.getVisibility() == View.VISIBLE) {
            Log.d("ClassicalKeyBoardUtil", "visible");
        }
    }
    ...
    public void initLayoutHeight(LinearLayout layoutView) {
        ...
        mIVClose = (TextView) layoutView.findViewById(R.id.iv_close);
...
//            Selection.setSelection(etext, start + 1);
        ...
        public void onRelease(int primaryCode) {
            if (inputType != ClassicalKeyBoardUtil.INPUTTYPE_NUM_ABC
        ...
        public void onPress(int primaryCode) {
            if (inputType == ClassicalKeyBoardUtil.INPUTTYPE_NUM_ABC ||
                    inputType == ClassicalKeyBoardUtil.INPUTTYPE_NUM ||
                    inputType == ClassicalKeyBoardUtil.INPUTTYPE_NUM_POINT ||
                    inputType == ClassicalKeyBoardUtil.INPUTTYPE_NUM_FINISH ||
                    inputType == ClassicalKeyBoardUtil.INPUTTYPE_NUM_NEXT ||
                    inputType == ClassicalKeyBoardUtil.INPUTTYPE_NUM_X) {
...
//                showKeyBoardLayout(ed, INPUTTYPE_SYMBOL, -1);
    ...
    private void initKeyBoard(int keyBoardViewID) {
        ...
        if (inflaterView != null) {
            keyboardView = (ClassicalKeyBoardView) inflaterView.findViewById(keyBoardViewID);
        } else {
            keyboardView = (ClassicalKeyBoardView) mActivity
    ...
    private void initInputType() {
        if (inputType == INPUTTYPE_NUM) {
            ...
            keyboardView.setPreviewEnabled(false);
            abcKeyboard = new Keyboard(mContext, R.xml.symbols_classical_abc);
